...
You can imagine the values outside the bounds of array as -infinity. So `arr[-1] = arr[n] = -infinity`</br>
NOTE: No two consecutive elements will be same, i.e. `arr[i] != arr[i + 1] for all valid i`
